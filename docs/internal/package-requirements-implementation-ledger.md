...
passes 22 word32 layout cases, including canonical rank-5/rank-6 positive-affine
and rank-1-through-rank-6 signed-affine source maps, without minting source-producer,
...
a separately bounded repeated/device-side feedback contract, rank-7+ domain,
or transport profile;

...
- The current Node 25 local gate passes 51 files/441 tests in 34.96 seconds,
  including a 24.48-second Vitest phase. Workflow structure tests prove the
  expensive jobs do not depend on the verification job while the final
  comparator depends on both.

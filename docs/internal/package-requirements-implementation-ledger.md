...
- **Current implementation slice:** Gate 2 packed8 and packed16 exact-storage breadth
...
Gate 2 now also owns distinct packed8 and packed16 exact-storage profiles for
bool/i8/u8 and i16/u16/f16/bf16 rank-2/rank-3 view copies. They deliberately
preserve raw storage only: bool bytes are not canonicalized, values are not
converted, and no packed arithmetic is claimed.
...
| Gate 2 view-family selection | `verified` | Selected typed JIT `PERMUTE` plus compiler L1 read binding and sibling L2 guarded materializing view copy. The required 31-case view-copy matrix covers separately identified rank-5/rank-6/rank-7 positive-affine word32, rank-1-through-rank-7 signed-affine word32 source, and positive-affine rank-2/rank-3 bool/i8/u8 packed8 and i16/u16/f16/bf16 packed16 profiles with exact CPU/WebGPU parity. Packed8 and packed16 prove storage movement only; broader view or arithmetic families must add typed profiles rather than reinterpret existing identities. |

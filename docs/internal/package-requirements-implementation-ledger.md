...
The unified host operation now re-verifies both returned statements and invokes
the implemented backend and final-release compositions before process exit.

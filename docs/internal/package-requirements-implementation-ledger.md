...
- **Current implementation slice:** Gate 2 rank-7 non-word32 exact-storage breadth
...
| Gate 2 view-family selection | `verified` | Selected typed JIT `PERMUTE` plus compiler L1 read binding and sibling L2 guarded materializing view copy. The required 67-case view-copy matrix covers separately identified positive and signed-affine source profiles at ranks 1 through 7 across bool/i8/u8 packed8, i16/u16/f16/bf16 packed16, f32/i32/u32 word32, and f64/i64/u64 word64 storage with exact CPU/WebGPU parity. Packed8, packed16, and word64 prove storage movement only; broader view or arithmetic families must add typed profiles rather than reinterpret existing identities. |
...
passes 67 layout cases, including canonical rank-5-through-rank-7
positive-affine and rank-1-through-rank-7 signed-affine word32 source maps plus

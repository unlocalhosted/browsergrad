...
device-first/host-second CUDA actions and the canonical artifact-v3 writer.
Wasm page/allocator observations remain separate from logical VFS reservations
and browser-process memory.

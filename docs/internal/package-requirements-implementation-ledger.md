...
- **Current implementation slice:** Gate 6 framework convergence audit
...
The next software transition is Gate 6: audit advertised JIT/Grad/runtime
support against the typed semantic contracts and migrate one bounded operation
family through CPU, VJP/refusal, transform/export, WebGPU, and
residency/materialization decisions without widening opaque callback seams.

...
- **Current implementation slice:** Gate 2 word64 exact-storage breadth
...
Gate 2 now also owns distinct packed8, packed16, and word64 exact-storage
profiles for bool/i8/u8, i16/u16/f16/bf16, and f64/i64/u64 rank-2/rank-3 view
copies. They deliberately preserve raw storage only: bool bytes are not
canonicalized, values are not converted, and no non-word32 arithmetic is
claimed.

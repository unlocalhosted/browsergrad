...
| Gate 7 — host graphs and optional systems expansion | `in-progress` | Semantic-core verifies the bounded DAG, explicit resources/effects/hazards, collectives, copies, events, fail-stop materialization, fixed/runtime/produced-resource repetition, three predicate sources, request-time or produced-resource linear-prefix dispatch, version-1.24 exact shared-count linear fanout, version-1.12/1.13 request-time/produced-resource rank-2/rank-3 rectangles, version-1.14/1.15 rank-4 rectangles, version-1.16/1.17 rank-5 rectangles, version-1.18/1.19 rank-6 rectangles, version-1.20/1.21 rank-7 rectangles, version-1.22/1.23 request-time/produced-resource rank-8 rectangles, version-1.25 exact shared-rectangle fanout, version-1.26 one exact two-stage linear producer chain, and version-1.27 its exact three-stage extension. CPU and portable WebGPU execute through private storage and the same exact device-bound pipeline authority. Fanout reads one shared selection once; producer chains read each distinct selection only after its preceding selected dispatch completes. | Broader mixed/device-side feedback, nested/device-side branching, browser-worker transport/topology/failure evidence, native companion profiles, and stronger event synchronization remain open. | Focused semantic-core 2 files/62 tests and kernels 1 file/29 tests pass with strict typechecks; 64 complete-output CPU/WebGPU parity cases execute through explicit pipeline authority on Apple Metal 3; correctness artifact `3f08099ff57fe925c35bb0cc37770612061be5bf0397bed79119a086802ecf0f` under backend 1.30; separate backend-1.20 prewarmed performance observation. |

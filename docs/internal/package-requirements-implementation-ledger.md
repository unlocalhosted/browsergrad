...
- **Current implementation slice:** Gate 6 Grad NumPy-interop convergence
...
The next Gate 6 software transition is NumPy interop, followed by generated
runtime/profile support consumption. Support must not be inferred from method
presence or duplicated in hand-maintained tables.

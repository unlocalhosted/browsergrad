...
- **Current implementation slice:** Gate 2 signed non-word32 exact-storage breadth
...
f64/i64/u64 rank-2/rank-3 view copies. They deliberately preserve raw storage

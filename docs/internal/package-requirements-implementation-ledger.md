...
- **Current implementation slice:** Gate 2 packed16 exact-storage breadth
...
Gate 2 now also owns a distinct packed16 exact-storage profile for
i16/u16/f16/bf16 rank-2/rank-3 view copies. It deliberately does not convert
values or claim f16/bf16 arithmetic.
...
| Gate 2 view-family selection | `verified` | Selected typed JIT `PERMUTE` plus compiler L1 read binding and sibling L2 guarded materializing view copy. The required 28-case view-copy matrix covers separately identified rank-5/rank-6/rank-7 positive-affine word32, rank-1-through-rank-7 signed-affine word32 source, and positive-affine rank-2/rank-3 i16/u16/f16/bf16 packed16 profiles with exact CPU/WebGPU parity. Packed16 proves storage movement only; broader view or arithmetic families must add typed profiles rather than reinterpret existing identities. |

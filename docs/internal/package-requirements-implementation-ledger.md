...
- **Current implementation slice:** Gate 4 frontend-neutral logical GEMM tile semantics, separate from physical schedule
...
real production Worker compile. The next software transition is Gate 4's first
frontend-neutral logical GEMM tile. It must define logical operands,
accumulation, boundary/mask, and collective meaning without selecting or
encoding workgroups, staging, MMA facilities, or another physical schedule.

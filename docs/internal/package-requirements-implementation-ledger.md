...
| Gate 3 — real C++/CuTe frontend slice | `in-progress` | Browser-local Clang-Wasm remains the primary portable-product producer. The five-pack/5,788-file header universe is reproducible under a narrow stable header-input projection. Runtime ABI 1.16 now closes the Artifact V3 result ceiling at 32 MiB, retains an independent 8 MiB diagnostic cap, and accounts for an exact 564 MiB maximum Worker reservation. Exact-source run `30062037424` compiled unchanged C++17/CuTe source in the real browser Worker and emitted one accepted source-derived rank-2 pointer/Tensor/`cute::copy` Artifact V3 plus the shared view-copy semantic candidate. Docker stays outside the portable runtime graph. | Admit the exact successful bytes through current two-clean-build package reproducibility, then admit the observed candidate through externally rooted producer trust, shared lowering, and required real WebGPU. Independently obtain external approval for the exact file map/notices and an externally issued exact-build statement under the production signer policy. Broader dtype/layout profiles remain separate capabilities. | Commit `6d5c8bca`; fast gate 85 files/742 tests; required native boundary 49 files/263 tests with 9 explicit skips. Diagnostic Wasm SHA-256 `c5e40d131c4ab004a1b70fb7a0ba56c2f0379afd65da5add47ec4330e5bc6ae8`, 31,839,835 bytes. Worker execution `bg.cpp.browser-worker-execution.sha256.d7e21e61a6d800a7f48d7a414e171e6d8b778e435f71021a4ee8c4f1a33d860a`; Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.9586262a68581d0c1bcddcc8eea50f5499a5fc3cfd2c5eee819cfc3788a745ee`; candidate `bg.cpp.browser-worker-view-copy-candidate.sha256.a5c97510863338b8a2fe70f77caf5f1c1129450dbe7af736f3c19d7f598fe432`. Reproducibility run `30062294974` is active. `producerTrusted`, license approval, lowering authority, backend execution, and `releaseReady` remain false. |
...
| Gate 3 browser-local Clang-WASM producer | `partial` | Closed browser-local profile 2.6, producer-neutral request, Artifact V3, compilation contract 1.2, CUDA-pass authorities, exact semantic-adapter binding, separate raw-Wasm verifier/compiler Workers, closed VFS, canonical transfer, one-shot entry, and typed terminal protocol now compile a source-derived view-copy graph in the real browser Worker. ABI 1.16 raises the closed result ceiling to 32 MiB without widening the observed import surface, retains an independent diagnostic cap, and reports exact serialization/allocation first causes. | Replace diagnostic Wasm authority with package-pinned current reproducibility, then keep external producer trust, distribution approval, shared lowering, backend execution, and release as separate false authorities until the observed candidate crosses each boundary. | Exact-source run `30062037424`; Wasm SHA-256 `c5e40d131c4ab004a1b70fb7a0ba56c2f0379afd65da5add47ec4330e5bc6ae8`, 31,839,835 bytes; unchanged source SHA-256 `4134804a9892ed1f0a2778fae305e957b5a981afccf2a096f1585f3b1d4e6f06`; accepted Artifact V3 and source-derived candidate recorded above. |
| Gate 3 Clang-WASM build and distribution | `partial` | The lock pins the extractor closure, LLVM 22.1.8, Emscripten image, recipe, ABI, and distribution plan. Cached diagnostics remain untrusted and separate from clean/release authority. The independent reviewer remains fail-closed. The exact 17-file header subset is independently rehashed across two roots and package-pinned. Fast-validation now uploads a separate 3-day compact binary/review artifact; the successful run reduced the download from 20,953,923 to 9,407,272 bytes without weakening the full evidence artifact. | Finish two-clean-build and detached verification for the current lock, then close external file-level license approval, full distributed-output reproducibility, and production policy/external-signer evidence independently. | Current lock `bg.cpp.browser-build-input-lock.sha256.3e6742cde1fd6fa984d70af6b6b818e901696e666d4490475cd65f00dd53ca9c`; runtime ABI manifest `bg.cpp.browser-runtime-abi.sha256.a5ee4863dfe4a551d72f61dbf58033d2b21d101456da7f42f48d668fd82bdb1a`; header projection `bg.cpp.browser-header-input-projection.sha256.48490ddb7b2fe655ec36824e276b90122e2f548a77b768f5978029a31129c5b7`; header reproducibility ID `bg.cpp.browser-header-distribution-reproducibility.sha256.4d4c054fd4c93dbdbdef9581eeac52b037af3425e6a1c7eff8acc585abce1e55`; 17 outputs total 71,114,743 bytes. |
...
| Gate 3 Worker-owned VFS session | `partial` | One exact unshared Wasm memory serves canonical source snapshots and verified pack ranges through the six runtime-ABI imports. VFS preparation remains split into a memory-independent mount and one-time bind; canonical transfer preserves exact authorities and destructive ownership. The current diagnostic view-copy run mounted the five exact package-matched packs, installed 5,788 files, opened one source and 1,168 headers, and completed one accepted compile without ambient filesystem fallback. | Obtain external approval for the exact pack identities and repeat the observation with the promoted reproducible Wasm. | Worker execution `bg.cpp.browser-worker-execution.sha256.d7e21e61a6d800a7f48d7a414e171e6d8b778e435f71021a4ee8c4f1a33d860a`; package-pinned header packs matched. Header approval and externally rooted producer trust remain false. |
| Gate 3 Wasm runtime and frontend-work metrics | `partial` | C ABI 1.2 retains the exact allocator and generation-bound frontend-work records. Native callbacks count bounded preprocessing, AST, constexpr, template, and CUDA-pass work; overflow fails closed. Runtime ABI 1.16 adds fixed source-independent Artifact V3 serialization/result failure stages and closes the result ceiling at 32 MiB while retaining a separate 8 MiB normalized-diagnostic bound. | Repin the exact successful records with the reproducible Wasm; keep execution observation separate from trust, lowering, backend, and release authority. | Diagnostic view-copy compile 18.774 seconds, total browser execution 21.399 seconds, one accepted Artifact V3 terminal with raw-Wasm and exact-interface conformance observed. |
| Gate 3 Worker invocation/result protocol | `partial` | Exact profile/asset/VFS/request/ABI/verifier-evidence identities bind one invocation. Host transfer remains single-reservation/single-materialization with no network authority. The controller verifies Worker bytes, validates one terminal frame, closes every effect, and rebinds the retained verifier/invocation/request/profile/request-binding/artifact chain before minting execution evidence. Chromium now produced one accepted source-derived rank-2 view-copy candidate from unchanged source using exact current diagnostic Wasm bytes. Candidate authorization still requires the separately admitted externally rooted producer; backend authorization and release remain false. | Repeat with package-pinned reproducible Wasm, admit the externally rooted producer independently, then replay that exact payload through shared lowering, CPU, and required WebGPU. | Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.9586262a68581d0c1bcddcc8eea50f5499a5fc3cfd2c5eee819cfc3788a745ee`; candidate `bg.cpp.browser-worker-view-copy-candidate.sha256.a5c97510863338b8a2fe70f77caf5f1c1129450dbe7af736f3c19d7f598fe432`; `producerTrusted=false`, lowering false, backend false, release false. |
...
| Gate 3 browser view-copy authorization | `partial` | One exact observed Worker `view-copy` candidate and one exact independently admitted build producer are re-unwrapped and cross-bound to the retained Worker/profile/request/artifact lineage, the selected entry, and its prepared semantic subject. Only that composition enters the existing canonical `AuthorizedCppCuteFrontendArtifact` side table used by the producer-neutral view-copy lowerer. Candidate and authorization identities deliberately exclude source/destination allocation sizes and byte offsets; the lowerer accepts those explicit storage facts only after authorization. A real source-produced browser candidate is now observed; synthetic authority fixtures continue to prove the later authorization/lowering/WebGPU transition without pretending external producer trust. | Replace the diagnostic Wasm lineage with the promoted reproducible lineage and combine it with an externally rooted producer; keep browser execution and release authority separate. | Real candidate `bg.cpp.browser-worker-view-copy-candidate.sha256.a5c97510863338b8a2fe70f77caf5f1c1129450dbe7af736f3c19d7f598fe432`; existing authorized rank-2/rank-3 fixtures still pass CPU and required actual-WebGPU execution. `producerTrusted=false`, lowering false, backend false, release false for the real observation. |

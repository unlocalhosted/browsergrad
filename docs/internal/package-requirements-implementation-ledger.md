...
| Gate 3 — real C++/CuTe frontend slice | `in-progress` | Browser-local Clang-Wasm remains the primary portable-product producer. The configured five-pack/5,788-file header universe includes the exact CUDA 12.6.3 `libcurand` header component and a deterministic, provenance-bound Clang CUDA runtime-wrapper derivative. Two clean builds produced byte-identical Wasm and factory outputs, detached strict review package-pinned their exact reproducibility record, and Chromium used that exact Wasm to compile unchanged C++17/CuTe layout source in the dedicated compiler Worker. The strict terminal authenticates the stable accepted Artifact V3 and shared rank-2 layout candidate. This closes strict reproducible layout-only browser execution. It does not approve header redistribution, externally trust the producer, produce dynamic Tensor/view-copy semantics, authorize lowering/WebGPU execution, or make the release ready. Docker stays outside the portable runtime graph. | Produce dynamic `Tensor<Engine, Layout>` binding and copy/view semantics from real source through the canonical AST/artifact seam, then admit that exact observed candidate through externally rooted producer trust, shared lowering, and required real WebGPU. Independently obtain external approval for the exact file map/notices and an externally issued exact-build statement under the production signer policy. Broader dtype/layout profiles remain separate capabilities. | Two-clean-build run `30047077419` produced identical 31,653,752-byte Wasm with SHA-256 `7950c52270fdac4ea8cae36fbaafbde56cb61720242e10ea5881becf2fe4cfd4`; detached verifier run `30049923259` emitted the package-pinned 3,470-byte reproducibility resource with SHA-256 `974bcaae92e88522f2a8ed91874c50269fbe0a84ec00823508495e3f034ac047`. Strict Chromium execution compiled in 21.133 seconds, accepted Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.4489656ea0da6faef2a37164fd73e36e201e15f4fba640fa88395a46deb81991`, and emitted Worker evidence `bg.cpp.browser-worker-execution.sha256.fbff539a3f5a3ad532e21d24ab07665f1f7b5b434b8aec74d57b7ba5e3b69019`. The 2,886-byte observation is package-pinned at SHA-256 `bf4d378a92eda260a120da15651deac8d42c7324de490ad1009224a3e7761496`; `producerTrusted`, license approval, lowering, backend execution, and `releaseReady` remain false. |
...
| Gate 3 browser-local Clang-WASM producer | `partial` | Closed browser-local profile 2.6, producer-neutral request, Artifact V3, compilation contract 1.2, runtime ABI 1.9, CUDA-pass authorities, exact semantic-adapter binding, separate raw-Wasm verifier/compiler Workers, closed VFS, canonical transfer, one-shot entry, and typed terminal protocol now complete one strict package-pinned browser layout compile. The exact upstream Clang CUDA runtime wrapper is admitted by hash and transformed only through a closed profile that scopes NVIDIA's libc++ escape hatch, removes the unmatched macro pop, and preserves global macro-redefinition errors while accommodating Clang's intentional CUDA macro redefinitions. | Extend the AST producer from layout-only output to real dynamic Tensor binding and copy/view semantics. Keep external producer trust, distribution approval, shared lowering, backend execution, and release as separate false authorities until the exact source-produced result crosses each boundary. | Strict Chromium run: 5 packs/5,788 files; compile 21.133 seconds, total 24.331 seconds; Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.4489656ea0da6faef2a37164fd73e36e201e15f4fba640fa88395a46deb81991`; Worker evidence `bg.cpp.browser-worker-execution.sha256.fbff539a3f5a3ad532e21d24ab07665f1f7b5b434b8aec74d57b7ba5e3b69019`; semantic candidate `bg.cpp.browser-worker-layout-candidate.sha256.72f3b5933de96569359767f19fdaaed3eaadadc56ca5c297238abcc149c0d34d`; layout semantic hash `9c4ad2f7a3f05e21511c98873155d689ae2e6f253ef29ab1022945f0e2198be0`. The exact Wasm is package-pinned reproducible output; externally rooted producer trust is not claimed. |
| Gate 3 Clang-WASM build and distribution | `partial` | The lock pins the extractor closure, LLVM 22.1.8, Emscripten image, recipe, ABI, and distribution plan. Cached diagnostics remain untrusted and separate from clean/release authority. Runtime ABI 1.9 and the independent reviewer remain fail-closed. The exact header closure adds NVIDIA `libcurand` 10.3.7.77 and the configured upstream Clang CUDA wrapper derivative without weakening license or provenance boundaries. The 17-file header subset is independently rehashed across two roots and package-pinned. Two clean current-lock builds now reproduce the exact Wasm, factory, canonical link map, runtime closure, ABI review, native TableGen tools, commands, and environments; detached strict review package-pins that evidence. | Close external file-level license approval, complete full distributed-output reproducibility, and production policy/external signer evidence independently. Future extractor changes require a new current-lock reproducibility record before strict execution authority moves. | Current lock `bg.cpp.browser-build-input-lock.sha256.489aa5b8657d2b0a4309869dc4c18e2e32f58be03d25a4c7cf1c0c2b981d28a4`; two-clean-build run `30047077419`; detached verifier run `30049923259`; reproducibility resource SHA-256 `974bcaae92e88522f2a8ed91874c50269fbe0a84ec00823508495e3f034ac047`. Header reproducibility ID `bg.cpp.browser-header-distribution-reproducibility.sha256.43f703672ddbeaf1e6e6d544e3ed50721a2585e947b5d0a1e624293cac80d449`; package resource SHA-256 `8dafa7484a7ca7a5c12e6cb2128cfbbc22d2692a96ebc1581c81e48953ad8620`; 17 outputs total 71,114,813 bytes. The current focused fast harness passes 85 files/738 tests. |
...
| Gate 3 Worker-owned VFS session | `partial` | One exact unshared Wasm memory serves canonical source snapshots and verified pack ranges through the six runtime-ABI imports. VFS preparation remains split into a memory-independent mount and one-time bind; canonical transfer preserves exact authorities and destructive ownership. The strict reproducible Chromium run mounted five exact packs, installed 5,788 files, opened one source and 1,104 headers, and completed one accepted compile without ambient filesystem fallback. | Obtain external approval for the exact pack identities and preserve opened-file parity when the AST producer gains real dynamic Tensor/view-copy semantics. | Strict Worker execution evidence `bg.cpp.browser-worker-execution.sha256.fbff539a3f5a3ad532e21d24ab07665f1f7b5b434b8aec74d57b7ba5e3b69019`; package-pinned reproducible Wasm matched. Header approval and externally rooted producer trust remain false. |
| Gate 3 Wasm runtime and frontend-work metrics | `partial` | C ABI 1.2 retains the exact allocator record and 96-byte generation-bound frontend-work record. Native callbacks count bounded preprocessing, AST, constexpr, template, and CUDA-pass work; overflow fails closed. The strict reproducible browser lifecycle reaches the accepted terminal with exact runtime/VFS records. | Preserve and repin the records when the AST producer gains real dynamic Tensor/view-copy semantics; keep execution observation separate from trust, lowering, backend, and release authority. | Strict compile 21.133 seconds, total 24.331 seconds, accepted one Artifact V3 terminal with raw-Wasm and exact-interface conformance observed. |
| Gate 3 Worker invocation/result protocol | `partial` | Exact profile/asset/VFS/request/ABI/verifier-evidence identities bind one invocation. Host transfer remains single-reservation/single-materialization with no network authority. The controller verifies Worker bytes, validates one terminal frame, closes every effect, and rebinds the retained verifier/invocation/request/profile/request-binding/artifact chain before minting execution evidence. Chromium produced one accepted rank-2 layout candidate from unchanged source using the package-pinned reproducible Wasm. Candidate authorization still requires the separately admitted externally rooted producer; backend authorization and release remain false. | Produce a real dynamic Tensor/view-copy terminal, admit the externally rooted producer independently, then replay that exact payload through shared lowering, CPU, and required WebGPU. | Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.4489656ea0da6faef2a37164fd73e36e201e15f4fba640fa88395a46deb81991`; candidate `bg.cpp.browser-worker-layout-candidate.sha256.72f3b5933de96569359767f19fdaaed3eaadadc56ca5c297238abcc149c0d34d`; `producerTrusted=false`, lowering false, backend false, release false. |
...
the existing canonical local layout-lowering seam. The accepted rank-2 layout
terminal has now been repeated with the exact package-pinned two-clean-build
Wasm, stable pre-bind VFS imports, and closed asset set. It still cannot
authorize lowering because the current signer inputs are synthetic. The next
Worker proof is a real source-produced dynamic Tensor/view-copy terminal,
followed by externally rooted producer admission and production-path CPU plus
required real-WebGPU convergence over that exact payload.
...
The next executable product checkpoint is real source-produced dynamic
`Tensor<Engine, Layout>` binding plus copy/view Artifact V3 output using Clang
AST and canonical semantic facts, not source-spelling handlers. The strict
browser lane must preserve exact source spans, diagnostics, selected-entry
identity, the closed VFS, and package-pinned reproducibility. Once the
independent external signer transition exists, that exact observed payload
must lower through the Gate 2 seam and match CPU plus required real WebGPU.

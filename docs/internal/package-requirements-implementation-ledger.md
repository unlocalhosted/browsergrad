...
Optional AOT composition around the common request is closed and must remain
frozen unless parity work directly requires a change. Review and land browser
acquisition and installation authority over the closed v1 VFS packs next:
same-origin redirect-free fetch, exact hash/length verification,

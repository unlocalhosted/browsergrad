...
- **Current implementation slice:** Gate 7 bounded control
...
widen the graph implicitly. Transport/topology, worker meshes, native companion
execution, graph performance, and stronger event profiles remain later

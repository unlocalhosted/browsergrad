...
- **Current implementation slice:** Gate 3 producer/reviewer separation of duties
...
controlled reviewer key distinct from the producer key, and externally issued
exact-review statement. Neither

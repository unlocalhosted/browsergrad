...
| Gate 3 — real C++/CuTe frontend slice | `in-progress` | Browser-local Clang-Wasm remains the primary portable-product producer. The strict producer, runtime ABI 1.8, exact reproducible factory, zero-import package Worker, production controller, and bounded evidence authorities remain intact. The ordinary harness completes in 37.26 seconds and direct seven-archive distribution materialization completes in 23.1 to 25.4 seconds. The package-pinned normalization path extracts 5,769 source files plus eight exact license/copyright evidence files, emits five independently inspected VFS packs containing 5,768 files/67,470,214 bytes, admits the exact CUDA 12.6.3 redistribution index, rechecks all ten package notices, writes one canonical per-file review input, materializes all ten component-license files, and creates the deterministic aggregate notice. The configured header universe and complete package-owned external-review input are materialized; external license/distribution approval, full-distribution reproducibility, signed provenance, valid browser-local C++ execution, and release authority remain false. Docker stays outside the portable runtime graph. | Obtain external approval for the exact prepared file map, CUDA index, Linux/CUDA evidence, and notice identities; bind the approved pack/notice identities into the asset/provenance chain; then prove one unmodified browser-local source through authenticated Worker execution, shared semantics, and real WebGPU. | Capability commits `3acf5b65` through `061ce246`. The fast gate passes 49 files/434 tests; its focused test phase is 25.59 seconds. Exact pipeline ID: `bg.cpp.browser-header-pack-pipeline.sha256.35e0d574519cf799844dfb3f72c2b6e6ae00532224ee34ddbcab2ba3a6e03556`. The review-input ID remains `bg.cpp.header-distribution-review-input.sha256.28346afa0239011e988de9cd40818b9eff6bbeeecc6e7e4bf508137697f4dc82`; notice materialization ID is `bg.cpp.browser-header-notice-materialization.sha256.a560867d2614feeb1c460c2192435b5472780c5538ab8d0c11c2cf6207df430a`. Zero valid production Worker compiles or browser-local C++ executions. |
...
| Gate 3 deterministic header-pack selection and assembly | `partial` | The exact plan binds seven archives, eight header subtrees, and eight upstream license/copyright files. Admission streams all 252,406,685 archive bytes. The release-shaped pipeline accepts only the package-reviewed Darwin arm64 `/usr/bin/bsdtar` and Node 25.9.0/Zstandard closure, preserves case-distinct Linux paths in collision-free storage, verifies the configured Clang resource-header output, and writes five canonical packs containing 5,768 files/67,470,214 bytes. It also admits the exact 49,142-byte CUDA index, writes the deterministic complete `license-inventory.json`, copies all ten verifier-retained component notices, and constructs the exact aggregate notice. Every output is no-clobber, independently reread, and checked against the exact final file/directory tree. Policy remains non-authoritative: the prepared map still requires external review, and full-distribution reproducibility/release facts remain false. | Obtain external review of the exact prepared input, then bind independently approved pack/notice identities into the asset and provenance chain and mount only those exact packs inside the package Worker. | Capability commits `6351bcd4` through `061ce246`; fast gate 49 files/434 tests with strict typecheck/lint/architecture. Repeated direct exact materialization completes in 23.1 to 25.4 seconds with stable review, notice, aggregate, and pipeline identities. Aggregate SHA-256 is `9933f791012ac5662cc87a63cdf56d794893e59d49ac8a013c05f29709b4e30b` at 115,316 bytes. Pack hashes remain `fd7fb977...`, `f795494a...`, `4f1c39b7...`, `f66f1284...`, and `d04a460d...`. No license approval, production Worker compile, Docker, or browser execution occurred. |
...
header review input, and exact notice output materialization are now
independent narrow authorities. Preserve them while closing the external
distribution/license decision and complete asset/provenance closure. Neither
reproducible bytes nor a package-generated file map or notice bundle can
substitute for external approval.

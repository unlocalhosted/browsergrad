...
- **Current implementation slice:** Gate 6 Grad conversion convergence
...
The next Gate 6 software transition is cross-dtype `Tensor.to`, followed by
invalid dtype/device disambiguation, NumPy interop, and generated

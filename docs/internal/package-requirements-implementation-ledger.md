...
- **Current implementation slice:** Gate 3 exact signed-source distribution closure
...
| Gate 2 view-family selection | `verified` | Selected typed JIT `PERMUTE` plus compiler L1 read binding and sibling L2 guarded materializing view copy. The required 24-case view-copy matrix covers separately identified rank-5/rank-6/rank-7 positive-affine and rank-1-through-rank-7 signed-affine source profiles with exact CPU/WebGPU parity; broader view families must add typed operation variants rather than reinterpret frozen plans. |
...
passes 24 word32 layout cases, including canonical rank-5-through-rank-7
positive-affine and rank-1-through-rank-7 signed-affine source maps, without minting source-producer,
distribution, or release authority. The exact nine-case distribution lane now

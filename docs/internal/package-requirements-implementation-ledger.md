...
- **Current implementation slice:** Gate 2 rank-4 non-word32 exact-storage breadth
...
f64/i64/u64 rank-1-through-rank-4 view copies. They deliberately preserve raw storage
...
passes 28 layout cases, including canonical rank-5-through-rank-7
positive-affine and rank-1-through-rank-7 signed-affine word32 source maps plus
positive-affine rank-2/rank-3 i16/u16/f16/bf16 packed storage, without minting
source-producer, arithmetic/conversion, distribution, or release authority.

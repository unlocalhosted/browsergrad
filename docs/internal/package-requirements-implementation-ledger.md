...
| Gate 3 browser-local Clang-WASM producer | `partial` | Closed browser-local profile 2.6, producer-neutral request, Artifact V3, compilation contract 1.2, CUDA-pass authorities, exact semantic-adapter binding, separate raw-Wasm verifier/compiler Workers, closed VFS, canonical transfer, one-shot entry, and typed terminal protocol complete one strict package-pinned browser layout compile. The native producer now also extracts exact pointer/Tensor declarations, `cute::make_tensor`, and `cute::copy` from unchanged C++/CuTe source and emits the complete source-derived view-copy Artifact V3 graph; native host/device parity and spoof rejection pass. | Reconcile the three new Emscripten exception-dispatch imports and 15,304-element table observed in the current Wasm, then run the exact source-derived view-copy payload in the real browser Worker. Keep external producer trust, distribution approval, shared lowering, backend execution, and release as separate false authorities until that payload crosses each boundary. | Strict Chromium layout run: 5 packs/5,788 files; compile 21.133 seconds, total 24.331 seconds; Artifact V3 `bg.artifact.cpp-cute-frontend.sha256.4489656ea0da6faef2a37164fd73e36e201e15f4fba640fa88395a46deb81991`. The current diagnostic Wasm build completed in about 3 minutes 18 seconds before the exact ABI reviewer rejected the expanded exception-dispatch surface; no new browser authority was minted. |
| Gate 3 Clang-WASM build and distribution | `partial` | The lock pins the extractor closure, LLVM 22.1.8, Emscripten image, recipe, ABI, and distribution plan. Cached diagnostics remain untrusted and separate from clean/release authority. The independent reviewer remains fail-closed. The exact 17-file header subset is independently rehashed across two roots and package-pinned. Its stable identity is now derived from the narrow header-input projection, while every live run still reauthenticates the complete current build lock; extractor-only lock churn can no longer invalidate unchanged header bytes or be hidden by a permissive verifier. | Update and independently review the exact current Wasm ABI surface, obtain two-clean-build and detached verification evidence for the resulting current lock, then close external file-level license approval, full distributed-output reproducibility, and production policy/external signer evidence independently. | Current lock `bg.cpp.browser-build-input-lock.sha256.564b1f555f5488df381b0bcf7e9f95e52270607cef5ad24eaf0fe659ed78230a`; header projection `bg.cpp.browser-header-input-projection.sha256.48490ddb7b2fe655ec36824e276b90122e2f548a77b768f5978029a31129c5b7`; header reproducibility ID `bg.cpp.browser-header-distribution-reproducibility.sha256.4d4c054fd4c93dbdbdef9581eeac52b037af3425e6a1c7eff8acc585abce1e55`; package resource SHA-256 `7a39e78d7aa3f1f0ff68e4b7b095425c75aa5e3947b208cdc6c5c30b46524838`; 17 outputs total 71,114,743 bytes. The current focused fast harness passes 85 files/739 tests. |

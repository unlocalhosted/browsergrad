...
Last updated: 2026-07-04T16:36:40Z
...
| Fixed failure movement | Started from 87 failing real-world/audit cases; current verifier gate is green at src `469/0/0`, dist `469/0/0`; cuda-samples compile/codegen audit now has `0` hard fails; real corpus WebGPU fixture outputs are pinned `98/98` |
| Current focus | Pointer/vector storage correctness, texture/vector conversion, active-lane/control semantics, and hot-loop test speed |
| Active work item | Continue corpus-shaped surface/texture probes after scalar/vector unaligned byte-offset coverage |
...
Smoke current: `306/0/0`.

Full source e2e current: `469/0/0`.

Verifier current: src `469/0/0`, dist `469/0/0`.
...
- Perf/tooling:
  ...
  - WebGPU smoke after vector unaligned byte probes is `306/0/0`; slowest cases are still pre-existing texture/surface compound pointer-array probes, not the new unaligned cases; tiny unaligned probes run around `3ms`, so correctness repeat is useful but hard speedup thresholds can be timing-floor noisy

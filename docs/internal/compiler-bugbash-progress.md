...
Last updated: 2026-07-04T18:22:20Z
...
| Active work item | Fixed nested conditional helper-call laziness in branch conditions; continue next corpus-shaped probe only if we keep bugbash open |
...
- Active-lane/control family:
  ...
  - conditional helper-call RHS branch laziness is now green for pointer/atomic helper side effects in assignment RHS, local var initializers, device return expressions, standalone call arguments, and branch conditions, including nested expression contexts, outside and inside active-lane return-before-barrier lowering; keep probing vector-lane and loop-condition contexts

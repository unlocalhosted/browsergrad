...
Last updated: 2026-07-02T18:14:07Z
...
| Active work item | Selected-kernel reachability now also prevents unreferenced global `half` constants/device globals from requiring `shader-f16` |

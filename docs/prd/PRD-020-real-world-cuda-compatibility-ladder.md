...
- `NVIDIA/cuda-samples` at `b7c5481`: `357` kernel definitions, `149` direct
  ...
  conversion aliases, real CUDA `while` statement lowering, and alias-backed
...
- `NVIDIA/cuda-samples` at `b7c5481` remains `357` total kernel definitions,
  `>=149` WebGPU-runnable, and `<=208` hard gaps.

...
- `NVIDIA/cuda-samples` at `b7c5481`: `357` kernel definitions, `315` direct
...
- The current live aggregate gate is `989/1038` compile/codegen-ok across the four
  pinned corpora: CUDA-120 `240/240`, `cuda-samples` `315/357`, `llm.c`
...
- `NVIDIA/cuda-samples` at `b7c5481` remains `357` total kernel definitions,
  `>=315` compile/codegen-ok, and `<=41` hard gaps.

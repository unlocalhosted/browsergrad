...
| `runTensorGpuPlan` | Generic tensor-plan executor for primitive f32 BUFFER/LOAD/MATMUL/elementwise/shape/reduce/Conv1d/Conv2d/Conv3d-forward-backward steps with GPUBuffer residency and single root readback | ✅ |
...
- `runTensorGpuPlan(device, plan, inputs)` — generic tensor-IR plan executor.
  ...
  <= 4, plus Conv1d/Conv2d/Conv3d forward/backward. This is the future

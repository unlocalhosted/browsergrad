...
| `runTensorGpuPlan` | Generic tensor-plan executor for primitive f32 BUFFER/LOAD/MATMUL/elementwise/shape/reduce/Conv1d/Conv2d/Conv3d-forward-backward/SGD/Adam/AdamW-update steps with GPUBuffer residency and single root readback | ✅ |

...
const PLANNED_CASE_IDS = Object.freeze([
  ...
  "i8-rank5-permutation",
  "i8-rank5-negative-stride",
  "i8-rank6-permutation",
  ...
  "f16-rank5-permutation",
  "f16-rank5-negative-stride",
  "f16-rank6-permutation",
  ...
  "f64-rank5-permutation",
  "f64-rank5-negative-stride",
  "f64-rank6-permutation",
...
async function createEvidenceCases(): Promise<readonly EvidenceCase[]> {
  ...
  const rank8Permutation = await makeCase(
    "rank8-permutation",
    {
      ...
      sourceBytes: dimConstant("1024"),
      destinationBytes: dimConstant("1024"),
    },
    { kind: "reject" },
    sequenceWords(256, 0x43000000),
  );
  ...
  const rank8U32NegativeStride = await makeCase(
    "rank8-u32-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("1020"),
      sourceBytes: dimConstant("1024"),
      destinationBytes: dimConstant("1024"),
      dtype: "u32",
    },
    { kind: "reject" },
    sequenceWords(256, 0x80000000),
  );
  ...
  const i8Rank5Permutation = await makeCase(
    "i8-rank5-permutation",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(8, 0x11223344),
  );

  const i8Rank5NegativeStride = await makeCase(
    "i8-rank5-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("31"),
      sourceBytes: dimConstant("32"),
      destinationBytes: dimConstant("32"),
      dtype: "i8",
    },
    { kind: "reject" },
    sequenceWords(8, 0x55667788),
  );

  const i8Rank6Permutation = await makeCase(
    "i8-rank6-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(16, 0x12345678),
  );

  const i8Rank6NegativeStride = await makeCase(
    "i8-rank6-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("63"),
      sourceBytes: dimConstant("64"),
      destinationBytes: dimConstant("64"),
      dtype: "i8",
    },
    { kind: "reject" },
    sequenceWords(16, 0x87654321),
  );

  const i8Rank7Permutation = await makeCase(
    "i8-rank7-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(32, 0x13572468),
  );

  const i8Rank7NegativeStride = await makeCase(
    "i8-rank7-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("127"),
      sourceBytes: dimConstant("128"),
      destinationBytes: dimConstant("128"),
      dtype: "i8",
    },
  ...
  const f16Rank5Permutation = await makeCase(
    "f16-rank5-permutation",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(16, 0x33330000),
  );

  const f16Rank5NegativeStride = await makeCase(
    "f16-rank5-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("62"),
      sourceBytes: dimConstant("64"),
      destinationBytes: dimConstant("64"),
      dtype: "f16",
    },
    { kind: "reject" },
    sequenceWords(16, 0x44440000),
  );

  const f16Rank6Permutation = await makeCase(
    "f16-rank6-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(32, 0x55550000),
  );

  const f16Rank6NegativeStride = await makeCase(
    "f16-rank6-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("126"),
      sourceBytes: dimConstant("128"),
      destinationBytes: dimConstant("128"),
      dtype: "f16",
    },
    { kind: "reject" },
    sequenceWords(32, 0x66660000),
  );

  const f16Rank7Permutation = await makeCase(
    "f16-rank7-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(64, 0x77770000),
  );

  const f16Rank7NegativeStride = await makeCase(
    "f16-rank7-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("254"),
      sourceBytes: dimConstant("256"),
      destinationBytes: dimConstant("256"),
      dtype: "f16",
    },
  ...
  const f64Rank5Permutation = await makeCase(
    "f64-rank5-permutation",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(64, 0x72000000),
  );

  const f64Rank5NegativeStride = await makeCase(
    "f64-rank5-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("248"),
      sourceBytes: dimConstant("256"),
      destinationBytes: dimConstant("256"),
      dtype: "f64",
    },
    { kind: "reject" },
    sequenceWords(64, 0x73000000),
  );

  const f64Rank6Permutation = await makeCase(
    "f64-rank6-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(128, 0x74000000),
  );

  const f64Rank6NegativeStride = await makeCase(
    "f64-rank6-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("504"),
      sourceBytes: dimConstant("512"),
      destinationBytes: dimConstant("512"),
      dtype: "f64",
    },
    { kind: "reject" },
    sequenceWords(128, 0x75000000),
  );

  const f64Rank7Permutation = await makeCase(
    "f64-rank7-permutation",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
    ...
    { kind: "reject" },
    sequenceWords(256, 0x76000000),
  );

  const f64Rank7NegativeStride = await makeCase(
    "f64-rank7-negative-stride",
    {
      shape: dims("2", "2", "2", "2", "2", "2", "2"),
      sourceLocation: add(
      ...
      sourceByteOffset: dimConstant("1016"),
      sourceBytes: dimConstant("1024"),
      destinationBytes: dimConstant("1024"),
      dtype: "f64",
    },

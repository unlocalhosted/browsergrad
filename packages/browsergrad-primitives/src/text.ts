...
export interface ByteBpeReference {
...
export interface ByteBpeReferenceDefaults {
  readonly specialTokens?: readonly string[];
  readonly pretokenizerPattern?: string;
}

export interface ByteBpeReferenceModule {
  train_byte_bpe(
    input: string,
    vocabSize: number,
...
export function createByteBpeReference(
  defaults: ByteBpeReferenceDefaults = {},
): ByteBpeReference {
  return {
...
export const byteBpeReferenceModule = createByteBpeReferenceModule();

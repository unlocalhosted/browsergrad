...
describe("Python source registry", () => {
  it("registers the expected modules in install order", () => {
    ...
    expect(paths).toEqual([
      ...
      "browsergrad_jit/_cost_model.py",
  ...
  it("declares all 92 opcodes in _ir.py (core + typed framework + CNN + norm + fusion + autograd + AMP + optimizer)", () => {
    ...
    const ops = [
      ...
      "OP_EXP", "OP_LOG", "OP_ABS", "OP_CLAMP", "OP_COS", "OP_FLIP", "OP_PROD", "OP_REPEAT", "OP_REPEAT_INTERLEAVE", "OP_SIGN", "OP_SIN",
      "OP_CMP", "OP_MATMUL",
      ...
      "OP_EINSUM", "OP_L1_LOSS", "OP_SMOOTH_L1_LOSS",
      "OP_BINARY_CROSS_ENTROPY", "OP_BINARY_CROSS_ENTROPY_WITH_LOGITS",
      "OP_KL_DIV", "OP_NLL_LOSS", "OP_CROSS_ENTROPY",
      ...
      "OP_KL_DIV_VJP", "OP_NLL_LOSS_VJP", "OP_CROSS_ENTROPY_VJP",

...
describe("Python source registry", () => {
  ...
  it("declares all 61 opcodes in _ir.py (core + typed framework + CNN + norm + fusion + autograd + AMP + optimizer)", () => {
    ...
    const ops = [
      ...
      "OP_EXP", "OP_LOG", "OP_ABS", "OP_CLAMP", "OP_COS", "OP_FLIP", "OP_SIGN", "OP_SIN",
      "OP_CMP", "OP_MATMUL",

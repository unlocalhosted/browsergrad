...
`);
    ...
    const expected = [
      "ABS", "ADD", "BATCH_NORM_1D", "BATCH_NORM_1D_STATS_UPDATE", "BINARY_CROSS_ENTROPY", "BINARY_CROSS_ENTROPY_WITH_LOGITS", "BROADCAST_TO", "CAST", "CLAMP", "CONCAT", "CONV1D", "CONV2D", "CONV3D", "CONV_TRANSPOSE2D", "COS", "CROSS_ENTROPY",
      "CUMSUM", "DIV", "DROPOUT", "EINSUM", "EXP", "FLIP", "INDEX", "INTERPOLATE_2D", "ISNAN", "KL_DIV", "L1_LOSS", "LAYER_NORM", "LOG", "MATMUL", "MUL",
      "NEG", "NLL_LOSS", "PAD", "PERMUTE", "PROD", "REDUCE", "REPEAT", "REPEAT_INTERLEAVE", "RESHAPE", "SCATTER", "SIGN", "SIN", "SMOOTH_L1_LOSS", "SORT_INDICES", "SORT_VALUES", "STACK", "TOPK_INDICES", "TOPK_VALUES", "TRIL", "TRIU", "VAR", "WHERE",
    ];

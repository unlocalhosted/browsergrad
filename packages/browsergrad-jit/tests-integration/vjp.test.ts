...
`);
    ...
    const expected = [
      ...
      "NEG", "PAD", "PERMUTE", "PROD", "REDUCE", "REPEAT", "REPEAT_INTERLEAVE", "RESHAPE", "SCATTER", "SIGN", "SIN", "SMOOTH_L1_LOSS", "SORT_INDICES", "SORT_VALUES", "STACK", "TOPK_INDICES", "TOPK_VALUES", "TRIL", "TRIU", "VAR", "WHERE",
    ];

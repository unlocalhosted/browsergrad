...
`);
  ...
  it("exposes 100 opcodes in ALL_OPS (core + typed framework + CNN + norm + fusion + autograd + AMP + optimizer)", async () => {
    const target = await getJitTarget();
...
`);
    ...
    expect(ops).toContain("ATTENTION_FORWARD");
    ...
    expect(ops).toContain("BINARY_CROSS_ENTROPY");
    expect(ops).toContain("BINARY_CROSS_ENTROPY_VJP");
    expect(ops).toContain("BINARY_CROSS_ENTROPY_WITH_LOGITS");
    expect(ops).toContain("BINARY_CROSS_ENTROPY_WITH_LOGITS_VJP");
    expect(ops).toContain("KL_DIV");
    expect(ops).toContain("KL_DIV_VJP");
    expect(ops).toContain("NLL_LOSS");
    expect(ops).toContain("NLL_LOSS_VJP");
    expect(ops).toContain("CROSS_ENTROPY");
    expect(ops).toContain("CROSS_ENTROPY_VJP");
    expect(ops).toContain("DROPOUT");
    expect(ops).toContain("DROPOUT_VJP");
    expect(ops).toContain("BATCH_NORM_1D");
    expect(ops).toContain("BATCH_NORM_1D_STATS_UPDATE");
    expect(ops).toContain("BATCH_NORM_1D_VJP");
    expect(ops).toContain("TOPK_INDICES");
    expect(ops).toContain("TOPK_VALUES");
    expect(ops).toContain("SCATTER");
    expect(ops).toContain("EINSUM");
    expect(ops).toContain("EINSUM_VJP");
    expect(ops).toContain("ABS");
    expect(ops).toContain("CLAMP");
    expect(ops).toContain("COS");
    expect(ops).toContain("FLIP");
    expect(ops).toContain("TRIL");
    expect(ops).toContain("TRIU");
    expect(ops).toContain("INDEX");
    expect(ops).toContain("PROD");
    expect(ops).toContain("VAR");
    ...
    expect(ops).toContain("LAYER_NORM");
    expect(ops).toContain("LAYER_NORM_BACKWARD_INPUT");
    expect(ops).toContain("LAYER_NORM_BACKWARD_WEIGHT");
    expect(ops).toContain("LAYER_NORM_BACKWARD_BIAS");
    expect(ops).toContain("SGD_UPDATE");
    expect(ops).toContain("ADAMW_UPDATE_M");
    expect(ops).toContain("ADAMW_UPDATE_V");
    expect(ops).toContain("ADAMW_UPDATE_PARAM");
    expect(ops).toContain("ADAM_UPDATE_M");
    expect(ops).toContain("ADAM_UPDATE_V");
    expect(ops).toContain("ADAM_UPDATE_PARAM");
  });

...
export const HOST_GRAPH_ARTIFACT_MINOR = 33;
...
function parseProgram(
  ...
  if (
    ...
    invalid(
      ...
      "$.payload.program.version",
      "host graph program reader supports versions 1.0 through 1.33 only",
    );
  }
  const programMinor =

...
function validateInlineAsmStatement(
  ...
  if (op?.kind === "ffs-b32" && (outputs.length !== 1 || statement.inputs.length !== 1)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "ffs.b32 inline PTX expects one output operand and one input operand", statement.span));
  }
  if (op?.kind === "ffs-b32" && outputInfos[0]?.valueType !== undefined && outputInfos[0]?.valueType !== "uint" && outputInfos[0]?.valueType !== "int") {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "ffs.b32 inline PTX writes an integer output operand", outputs[0]?.span ?? statement.span));
  }
  if (op?.kind === "popc-b32" && (outputs.length !== 1 || statement.inputs.length !== 1)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "popc.b32 inline PTX expects one output operand and one input operand", statement.span));
  }
  if (op?.kind === "popc-b32" && outputInfos[0]?.valueType !== undefined && outputInfos[0]?.valueType !== "uint" && outputInfos[0]?.valueType !== "int") {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "popc.b32 inline PTX writes an integer output operand", outputs[0]?.span ?? statement.span));
  }
  if (op?.kind === "clz-b32" && (outputs.length !== 1 || statement.inputs.length !== 1)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "clz.b32 inline PTX expects one output operand and one input operand", statement.span));
  }
  if (op?.kind === "clz-b32" && outputInfos[0]?.valueType !== undefined && outputInfos[0]?.valueType !== "uint" && outputInfos[0]?.valueType !== "int") {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "clz.b32 inline PTX writes an integer output operand", outputs[0]?.span ?? statement.span));
  }
  if (op?.kind === "brev-b32" && (outputs.length !== 1 || statement.inputs.length !== 1)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", "brev.b32 inline PTX expects one output operand and one input operand", statement.span));
  }
  ...
  if (op?.kind === "arithmetic-b32" && outputInfos[0]?.valueType !== undefined && outputInfos[0]?.valueType !== "uint" && outputInfos[0]?.valueType !== "int") {
    const opLabel = op.op === "mul-lo" ? "mul.lo" : op.op === "mad-lo" ? "mad.lo" : op.op;
  ...
  if (op?.kind === "select-b32" && (outputs.length !== 1 || statement.inputs.length !== 3)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", `selp.${op.signed ? "s32" : "b32"} inline PTX expects one output operand and three input operands`, statement.span));
  }
  if (op?.kind === "select-b32" && outputInfos[0]?.valueType !== undefined && outputInfos[0]?.valueType !== "uint" && outputInfos[0]?.valueType !== "int") {
    asmDiagnostics.push(error("invalid-inline-asm-operands", `selp.${op.signed ? "s32" : "b32"} inline PTX writes an integer output operand`, outputs[0]?.span ?? statement.span));
  }
  if (op?.kind === "compare-b32" && (outputs.length !== 1 || statement.inputs.length !== 2)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", `setp.${op.op}.${op.signed ? "s32" : "u32"} inline PTX expects one output operand and two input operands`, statement.span));
  }
  ...
  if (op?.kind === "convert-b32" && (outputs.length !== 1 || statement.inputs.length !== 1)) {
    asmDiagnostics.push(error("invalid-inline-asm-operands", `cvt.${op.toSigned ? "s32" : "u32"}.${op.fromSigned ? "s32" : "u32"} inline PTX expects one output operand and one input operand`, statement.span));
  }

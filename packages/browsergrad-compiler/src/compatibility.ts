...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-constant-memory", "memory", "Constant memory", "unsupported", false, true, "Readonly scalar inputs, initialized scalar/array constants, and readonly constant arrays lower through modeled memory paths; remaining vector/advanced constant-memory forms need backend-neutral semantic lowering."),

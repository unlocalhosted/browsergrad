...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-local-pointer", "memory", "Local pointer aliases", "unsupported", false, true, "Fixed local-array element aliases are lowered into semantic IR; remaining local pointer forms need modeled alias rules."),

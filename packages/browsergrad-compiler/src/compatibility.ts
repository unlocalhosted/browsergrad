...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-subgroup", "subgroup", "Unsupported subgroup primitive", "unsupported", false, true, "__activemask, __any_sync, __all_sync, __ballot_sync, and __reduce_add_sync lower through semantic IR to native WebGPU subgroup operations; __match_any_sync and __shfl_sync/__shfl_down_sync/__shfl_up_sync/__shfl_xor_sync lower through semantic IR to native WebGPU workgroup-memory helpers with scalar/reference coverage; remaining subgroup operations require modeled WebGPU subgroup or scalar fallback semantics."),

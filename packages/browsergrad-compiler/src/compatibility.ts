...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-surface", "texture", "Unsupported surface access", "unsupported", false, true, "Direct scalar/vector surface reads, scalar surface writes, and scalar/vector surface helper params lower through semantic IR; advanced surface forms use remaining modeled paths or are unsupported."),

...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-curand", "library", "cuRAND deterministic state helpers", "native", true, true, "curand_init plus curand/curand_uniform/curand_uniform_double/curand_normal/curand_normal_double/curand_log_normal/curand_log_normal_double over modeled local, shared, or storage curandState_t lower through semantic IR to deterministic native WebGPU helpers; Sobol states, host RNG APIs, and remaining advanced distributions stay unsupported."),

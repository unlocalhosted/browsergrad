...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-remquo-quotient", "math", "Unsupported remquo quotient target", "unsupported", false, true, "Finite-literal statement, assignment-RHS, and var-init remquo storage quotient outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled integer storage."),

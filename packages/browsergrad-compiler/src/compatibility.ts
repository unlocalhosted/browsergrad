...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-local-array-init", "memory", "Local array initializers", "unsupported", false, true, "Braced and scalar-fill scalar local array initializers lower through semantic IR; remaining initializer forms must resolve to modeled scalar values or braced vector values."),

...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-texture", "texture", "Texture/surface access", "unsupported", false, true, "Scalar direct tex2D/tex2DLod paths, direct point/linear 2D texture descriptors, and descriptor-specialized texture-helper-param tex2D/tex2DLod paths lower through semantic IR; vector, atlas, and advanced texture forms use remaining modeled paths or are unsupported."),

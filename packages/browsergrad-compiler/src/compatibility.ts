...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-call", "library", "Unsupported CUDA/device call", "unsupported", false, true, "__isGlobal/__isShared/__isConstant/__isLocal lower as semantic address-space predicates; remaining calls need semantic builtin or library island."),

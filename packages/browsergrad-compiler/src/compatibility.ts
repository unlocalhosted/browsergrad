...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-frexp-exponent", "math", "Unsupported frexp exponent target", "unsupported", false, true, "Finite-literal statement frexp storage exponent outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled integer storage."),
  feature("unsupported-modf-intpart", "math", "Unsupported modf integer-part target", "unsupported", false, true, "Finite-literal statement modf storage outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled float storage."),
  ...
  feature("unsupported-remquo-quotient", "math", "Unsupported remquo quotient target", "unsupported", false, true, "Finite-literal statement remquo storage quotient outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled integer storage."),

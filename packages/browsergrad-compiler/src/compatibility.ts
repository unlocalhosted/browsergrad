...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-call", "library", "Unsupported CUDA/device call", "unsupported", false, true, "__isGlobal/__isShared/__isConstant/__isLocal lower as semantic address-space predicates; __syncthreads_count/__syncthreads_and/__syncthreads_or lower through native WebGPU workgroup-memory collectives; remaining calls need semantic builtin or library island."),

...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-subgroup", "subgroup", "Unsupported subgroup primitive", "unsupported", false, true, "__activemask, __any_sync, __all_sync, __ballot_sync, and __reduce_add_sync lower through semantic IR to native WebGPU subgroup operations with scalar fallback coverage; remaining subgroup operations require modeled WebGPU subgroup or scalar fallback semantics."),

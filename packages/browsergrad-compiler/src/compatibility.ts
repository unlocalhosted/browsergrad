...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-modf-intpart", "math", "Unsupported modf integer-part target", "unsupported", false, true, "Finite-literal statement, assignment-RHS, and var-init modf storage outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled float storage."),

...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-surface", "texture", "Unsupported surface access", "unsupported", false, true, "Surface operations require modeled surface object bindings."),

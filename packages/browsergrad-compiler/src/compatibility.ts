...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-frexp-exponent", "math", "Unsupported frexp exponent target", "unsupported", false, true, "Finite-literal statement, assignment-RHS, and var-init frexp storage exponent outputs lower through semantic IR; local/direct storage outputs are supported in scalar var initializers, assignment RHS, and modeled statement lowering; remaining forms must target modeled integer storage."),

...
const BUILTIN_FEATURES: readonly CudaFeatureRecord[] = [
  ...
  feature("unsupported-pointer-conditional", "memory", "Unsupported pointer conditional", "unsupported", false, true, "Same-root fixed local-array pointer conditionals and nullable local-array pointer conditionals are lowered into semantic IR; remaining pointer conditionals require compatible modeled pointer branches."),
  feature("unsupported-pointer-pointer-comparison", "memory", "Unsupported pointer comparison", "unsupported", false, true, "Same-root fixed local-array pointer comparisons, local pointer/null comparisons, and nullable local pointer equality comparisons are lowered into semantic IR; remaining pointer comparison requires null checks or addresses in the same modeled address system."),

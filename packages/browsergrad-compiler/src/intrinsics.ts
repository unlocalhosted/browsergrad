...
const BF16_INTRINSICS = [
  ...
  intrinsic("__ll2bfloat16_rn", [1, 1], "bf16", (args) => roundBfloat16(Math.trunc(args[0] ?? 0) | 0), (args) => wgslRoundBfloat16(`f32(i32(${args[0] ?? "0"}))`)),
  intrinsic("__ll2bfloat16_rz", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) | 0, "rz"), (args) => wgslRoundBfloat16(`f32(i32(${args[0] ?? "0"}))`, "rz")),
  intrinsic("__ll2bfloat16_ru", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) | 0, "ru"), (args) => wgslRoundBfloat16(`f32(i32(${args[0] ?? "0"}))`, "ru")),
  intrinsic("__ll2bfloat16_rd", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) | 0, "rd"), (args) => wgslRoundBfloat16(`f32(i32(${args[0] ?? "0"}))`, "rd")),
  ...
  intrinsic("__ull2bfloat16_rn", [1, 1], "bf16", (args) => roundBfloat16(Math.trunc(args[0] ?? 0) >>> 0), (args) => wgslRoundBfloat16(`f32(u32(${args[0] ?? "0"}))`)),
  intrinsic("__ull2bfloat16_rz", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) >>> 0, "rz"), (args) => wgslRoundBfloat16(`f32(u32(${args[0] ?? "0"}))`, "rz")),
  intrinsic("__ull2bfloat16_ru", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) >>> 0, "ru"), (args) => wgslRoundBfloat16(`f32(u32(${args[0] ?? "0"}))`, "ru")),
  intrinsic("__ull2bfloat16_rd", [1, 1], "bf16", (args) => roundFloat32ToBfloat16(Math.trunc(args[0] ?? 0) >>> 0, "rd"), (args) => wgslRoundBfloat16(`f32(u32(${args[0] ?? "0"}))`, "rd")),
  ...
  intrinsic("__bfloat162ll_rn", [1, 1], "int", (args) => roundTiesToEven(args[0] ?? 0) | 0, (args) => `i32(bg_round_even_f32(f32(${args[0] ?? "0"})))`),
  intrinsic("__bfloat162ll_rz", [1, 1], "int", (args) => Math.trunc(args[0] ?? 0), (args) => `i32(trunc(f32(${args[0] ?? "0"})))`),
  intrinsic("__bfloat162ll_ru", [1, 1], "int", (args) => Math.ceil(args[0] ?? 0) | 0, (args) => `i32(ceil(f32(${args[0] ?? "0"})))`),
  intrinsic("__bfloat162ll_rd", [1, 1], "int", (args) => Math.floor(args[0] ?? 0) | 0, (args) => `i32(floor(f32(${args[0] ?? "0"})))`),
  intrinsic("__bfloat162ull_rn", [1, 1], "uint", (args) => roundTiesToEven(args[0] ?? 0) >>> 0, (args) => `u32(max(bg_round_even_f32(f32(${args[0] ?? "0"})), 0.0))`),
  intrinsic("__bfloat162ull_rz", [1, 1], "uint", (args) => Math.trunc(args[0] ?? 0) >>> 0, (args) => `u32(max(trunc(f32(${args[0] ?? "0"})), 0.0))`),
  intrinsic("__bfloat162ull_ru", [1, 1], "uint", (args) => Math.ceil(args[0] ?? 0) >>> 0, (args) => `u32(max(ceil(f32(${args[0] ?? "0"})), 0.0))`),
  intrinsic("__bfloat162ull_rd", [1, 1], "uint", (args) => Math.floor(args[0] ?? 0) >>> 0, (args) => `u32(max(floor(f32(${args[0] ?? "0"})), 0.0))`),

...
const gates = [
  ...
  ["pnpm", ["--filter", "@unlocalhosted/browsergrad-compiler", "test:browser:layout-bindings:required"], repoRoot],
  ["pnpm", ["--filter", "@unlocalhosted/browsergrad-compiler", "test:browser:view-copy-bindings:required"], repoRoot],

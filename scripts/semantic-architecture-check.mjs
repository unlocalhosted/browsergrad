...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    dtypeContract: new Set(["preserve-floating-input", "preserve-input", "preserve-input-require-bool-mask", "preserve-real-numeric-input", "preserve-source-require-int64-index", "promote-integral-default-or-explicit-scan-dtype"]),
    cpu: new Set(["supported-numpy-dtype-preserving", "supported-numpy-owning-copy", "supported-numpy-owning-copy-with-range-check", "supported-numpy-owning-scan-copy"]),

...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    shapeContract: new Set(["preserve-single-axis-reverse", "preserve-unary-input", "static-broadcast-with-existing-dim-minus-one", "tile-multipliers-with-left-rank-padding"]),
    ...
    closureAutograd: new Set(["supported-cos-derivative", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-negative-sin-derivative", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-derivative"]),
    symbolicVjp: new Set(["supported-cos-derivative", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-negative-sin-derivative", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-derivative"]),
    ...
    onnxExport: new Set(["supported-opset17-clip-export-dtypes", "supported-opset17-direct-unary-export-dtypes", "supported-opset17-expand", "supported-opset17-slice-float32-int32-int64-bool", "supported-opset17-tile-float32-int32-int64-bool"]),
    tensorPlan: new Set(["refused-negative-stride-profile", "refused-no-canonical-tile-layout-profile", "refused-no-portable-lowering", "supported-primitive"]),
    webgpu: new Set(["profile-nonempty-f32-rank-at-most-4", "refused-negative-stride-profile", "refused-no-canonical-tile-layout-profile", "refused-no-tensor-plan-kernel"]),

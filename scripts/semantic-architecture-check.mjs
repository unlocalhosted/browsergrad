...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    functionalGrad: new Set(["supported-for-floating-output-via-symbolic-vjp", "supported-for-floating-source-and-output-via-symbolic-vjp", "supported-via-symbolic-vjp"]),
    vmap: new Set(["supported-leading-batch-axis", "supported-leading-batch-axis-preserve-matrix-axes", "supported-leading-batch-axis-with-axis-shift", "supported-leading-batch-axis-with-axis-shift-and-captured-broadcast", "supported-leading-batch-axis-with-index-axis-shift", "supported-leading-batch-axis-with-mask-broadcast", "supported-leading-batch-axis-with-scan-axis-shift", "supported-leading-batch-axis-with-unit-repeat"]),

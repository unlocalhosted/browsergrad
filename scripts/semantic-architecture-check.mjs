...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    shapeContract: new Set(["canonical-general-einstein-contraction", "preserve-batched-lower-triangular", "preserve-batched-upper-triangular", "preserve-single-axis-inclusive-scan", "preserve-single-axis-reverse", "preserve-source-with-broadcast-bool-mask", "preserve-unary-input", "same-rank-index-shaped-gather", "same-rank-unique-index-overwrite-scatter", "same-shape-axis-ordering", "selected-axis-becomes-exact-k", "selected-axis-times-repeat-count", "static-broadcast-with-existing-dim-minus-one", "static-product-reduction", "static-variance-reduction", "tile-multipliers-with-left-rank-padding", "trailing-dimension-constant-padding", "variadic-existing-axis-concatenation-with-legacy-empty", "variadic-new-axis-stacking"]),
    dtypeContract: new Set(["dimensioned-tensor-promotion-with-fp32-half-accumulator", "preserve-floating-input", "preserve-input", "preserve-input-require-bool-mask", "preserve-real-numeric-input", "preserve-source-require-int64-index", "preserve-supported-input-with-exact-fill", "preserve-target-require-int64-index-matching-source", "promote-integral-default-or-explicit-scan-dtype", "values-preserve-input-indices-int64", "pytorch-dimensioned-tensor-promotion"]),
    cpu: new Set(["supported-numpy-dtype-preserving", "supported-numpy-owning-concatenation-copy", "supported-numpy-owning-constant-pad-copy", "supported-numpy-owning-copy", "supported-numpy-owning-copy-with-range-check", "supported-numpy-owning-greedy-einsum", "supported-numpy-owning-partial-topk-indices", "supported-numpy-owning-scan-copy", "supported-numpy-owning-sort-gather", "supported-numpy-owning-stable-sort-indices", "supported-numpy-owning-stack-copy", "supported-numpy-owning-topk-gather", "supported-numpy-owning-unique-overwrite-scatter"]),
    closureAutograd: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-general-einsum-vjp", "supported-idempotent-triangular-selection", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "not-applicable-discrete-indices", "supported-negative-sin-derivative", "supported-permutation-scatter", "supported-unique-overwrite-scatter", "supported-opposite-direction-inclusive-scan-for-floating-source-and-output", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-static-axis-index", "supported-static-axis-split", "supported-static-interior-slice", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    symbolicVjp: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-general-einsum-vjp", "supported-idempotent-triangular-selection", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "not-applicable-discrete-indices", "supported-negative-sin-derivative", "supported-permutation-scatter", "supported-unique-overwrite-scatter", "supported-opposite-direction-inclusive-scan-for-floating-source-and-output", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-static-axis-index", "supported-static-axis-split", "supported-static-interior-slice", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    functionalGrad: new Set(["not-applicable-discrete-output", "supported-for-floating-input-via-symbolic-vjp", "supported-for-floating-output-via-symbolic-vjp", "supported-for-floating-source-and-output-via-symbolic-vjp", "supported-for-floating-target-and-source-via-symbolic-vjp", "supported-via-symbolic-vjp"]),
    vmap: new Set(["supported-leading-batch-axis", "supported-leading-batch-axis-preserve-matrix-axes", "supported-leading-batch-axis-preserving-pad", "supported-leading-batch-axis-with-axis-shift", "supported-leading-batch-axis-with-axis-shift-and-captured-broadcast", "supported-leading-batch-axis-with-einsum-captured-broadcast", "supported-leading-batch-axis-with-index-axis-shift", "supported-leading-batch-axis-with-mask-broadcast", "supported-leading-batch-axis-with-scan-axis-shift", "supported-leading-batch-axis-with-scatter-captured-broadcast", "supported-leading-batch-axis-with-unit-repeat"]),
    onnxExport: new Set(["supported-opset17-clip-export-dtypes", "supported-opset17-concat-with-casts-float32-int32-int64-bool", "supported-opset17-cumsum-with-cast-float32-int32-int64", "supported-opset17-direct-unary-export-dtypes", "supported-opset17-expand", "supported-opset17-full-axis-topk-gather-float32-int32-int64", "supported-opset17-gather-elements-float32-int32-int64-bool", "supported-opset17-pad-float32-int32-int64", "supported-opset17-reduce-prod-float32-int32-int64", "supported-opset17-resolved-einsum-numeric-dtypes", "supported-opset17-scatter-elements-float32-int32-int64-bool", "supported-opset17-selected-k-topk-gather-float32-int32-int64", "supported-opset17-slice-float32-int32-int64-bool", "supported-opset17-tile-float32-int32-int64-bool", "supported-opset17-trilu-float32-int32-int64-bool", "supported-opset17-unsqueeze-concat-with-casts-float32-int32-int64-bool", "supported-opset17-unsqueeze-tile-reshape-float32-int32-int64-bool", "supported-opset17-variance-decomposition-float32", "supported-opset17-where-float32-int32-int64-bool"]),

...
export function validateGradCompatibilityInventory(inventory, fixture, freeze, filename = "grad-compatibility-inventory.json") {
  ...
  const conditions = new Set(["all-inputs", "different-dtype-with-nonfloating-endpoint", "different-supported-floating-dtype", "index-kind-dependent", "input-dtype-and-index-kind-dependent", "input-dtype-and-layout-dependent", "input-dtype-dependent", "input-layout-dependent", "no-requested-dtype", "requested-bf16-token", "requested-dtype-dependent", "requested-dtype-differs-from-storage-dtype", "requested-dtype-equals-storage-dtype", "surface-and-input-dependent", "torch-bfloat16-token", "unrecognized-string"]);

...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    shapeContract: new Set(["preserve-batched-lower-triangular", "preserve-batched-upper-triangular", "preserve-single-axis-inclusive-scan", "preserve-single-axis-reverse", "preserve-source-with-broadcast-bool-mask", "preserve-unary-input", "same-rank-index-shaped-gather", "same-shape-axis-ordering", "selected-axis-times-repeat-count", "static-broadcast-with-existing-dim-minus-one", "static-product-reduction", "static-variance-reduction", "tile-multipliers-with-left-rank-padding", "trailing-dimension-constant-padding", "variadic-existing-axis-concatenation-with-legacy-empty", "variadic-new-axis-stacking"]),

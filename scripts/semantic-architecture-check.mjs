...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    symbolicVjp: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-idempotent-triangular-selection", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "supported-negative-sin-derivative", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    functionalGrad: new Set(["supported-via-symbolic-vjp"]),
    vmap: new Set(["supported-leading-batch-axis", "supported-leading-batch-axis-preserve-matrix-axes", "supported-leading-batch-axis-with-axis-shift", "supported-leading-batch-axis-with-index-axis-shift", "supported-leading-batch-axis-with-mask-broadcast", "supported-leading-batch-axis-with-unit-repeat"]),

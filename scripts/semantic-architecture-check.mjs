...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    shapeContract: new Set(["preserve-single-axis-reverse", "preserve-source-with-broadcast-bool-mask", "preserve-unary-input", "same-rank-index-shaped-gather", "selected-axis-times-repeat-count", "static-broadcast-with-existing-dim-minus-one", "static-product-reduction", "static-variance-reduction", "tile-multipliers-with-left-rank-padding"]),
    ...
    closureAutograd: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "supported-negative-sin-derivative", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    symbolicVjp: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "supported-negative-sin-derivative", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    functionalGrad: new Set(["supported-via-symbolic-vjp"]),
    vmap: new Set(["supported-leading-batch-axis", "supported-leading-batch-axis-with-axis-shift", "supported-leading-batch-axis-with-index-axis-shift", "supported-leading-batch-axis-with-mask-broadcast", "supported-leading-batch-axis-with-unit-repeat"]),
    ...
    tensorPlan: new Set(["refused-negative-stride-profile", "refused-no-canonical-selected-axis-replication-profile", "refused-no-canonical-tile-layout-profile", "refused-no-deterministic-index-lowering", "refused-no-portable-lowering", "refused-no-portable-masked-selection", "supported-primitive"]),

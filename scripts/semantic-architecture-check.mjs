...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    shapeContract: new Set(["preserve-single-axis-reverse", "preserve-unary-input", "same-rank-index-shaped-gather", "selected-axis-times-repeat-count", "static-broadcast-with-existing-dim-minus-one", "static-product-reduction", "static-variance-reduction", "tile-multipliers-with-left-rank-padding"]),
    ...
    closureAutograd: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-negative-sin-derivative", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    symbolicVjp: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-negative-sin-derivative", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),

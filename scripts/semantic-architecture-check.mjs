...
function checkJitFrameworkOperationContracts(root, manifest, failures) {
  ...
  const allowed = {
    ...
    closureAutograd: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-general-einsum-vjp", "supported-idempotent-triangular-selection", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "not-applicable-discrete-indices", "supported-negative-sin-derivative", "supported-permutation-scatter", "supported-piecewise-difference-for-both-inputs", "supported-unique-overwrite-scatter", "supported-opposite-direction-inclusive-scan-for-floating-source-and-output", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-signed-difference-for-both-inputs", "supported-static-axis-index", "supported-static-axis-split", "supported-static-interior-slice", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    symbolicVjp: new Set(["supported-centered-variance-rule", "supported-cos-derivative", "supported-deterministic-scatter-add", "supported-general-einsum-vjp", "supported-idempotent-triangular-selection", "supported-inclusive-bound-mask", "supported-involutive-flip", "supported-mask-complement-selection", "not-applicable-discrete-indices", "supported-negative-sin-derivative", "supported-permutation-scatter", "supported-piecewise-difference-for-both-inputs", "supported-unique-overwrite-scatter", "supported-opposite-direction-inclusive-scan-for-floating-source-and-output", "supported-selected-axis-block-sum", "supported-sign-derivative", "supported-signed-difference-for-both-inputs", "supported-static-axis-index", "supported-static-axis-split", "supported-static-interior-slice", "supported-tile-block-sum", "supported-unbroadcast-sum", "supported-zero-aware-product-rule", "supported-zero-derivative"]),
    ...
    vmap: new Set(["supported-leading-batch-axis", "supported-leading-batch-axis-preserve-matrix-axes", "supported-leading-batch-axis-preserving-pad", "supported-leading-batch-axis-with-axis-shift", "supported-leading-batch-axis-with-axis-shift-and-captured-broadcast", "supported-leading-batch-axis-with-einsum-captured-broadcast", "supported-leading-batch-axis-with-index-axis-shift", "supported-leading-batch-axis-with-mask-broadcast", "supported-leading-batch-axis-with-per-example-reduction", "supported-leading-batch-axis-with-scan-axis-shift", "supported-leading-batch-axis-with-scatter-captured-broadcast", "supported-leading-batch-axis-with-unit-repeat"]),

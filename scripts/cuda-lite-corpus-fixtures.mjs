export const cudaLiteCorpusExecutionFixtures = [
  ...
  {
    sourceKey: "corpusCuda120Day81CooperativeReductionKernel",
    caseName: "corpus:cuda-120:day81_cooperativeReductionKernel_grid_sync",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-81-Cooperative-Groups:-Advanced-Patterns.md",
    kernelName: "cooperativeReductionKernel",
    workgroupSize: [4, 1, 1],
    options: { dynamicSharedMemory: { sdata: 16 } },
    launch: { gridDim: [2, 1, 1], blockDim: [4, 1, 1] },
  ...
  {
    sourceKey: "corpusCuda120Day84FaultTolerantReductionKernel",
    caseName: "corpus:cuda-120:day84_faultTolerantReductionKernel_grid_sync",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-84-Progress-Checkpoint.md",
    kernelName: "faultTolerantReductionKernel",
    workgroupSize: [4, 1, 1],
    options: { dynamicSharedMemory: { sdata: 16 } },
    launch: { gridDim: [2, 1, 1], blockDim: [4, 1, 1] },
    input: {
      buffers: {
        input: { type: "Float32Array", data: [1, 2, 3, 4, 5, 6, 7, 8] },
        output: { type: "Float32Array", length: 2 },
        blockDone: { type: "Int32Array", length: 2 },
      },
      scalars: { N: 8, numBlocks: 2 },
    },
    output: "output",
    expectedOutput: { type: "Float32Array", data: [36, 26] },
  },
  {
    sourceKey: "corpusCuda120Day84FaultTolerantReductionKernelBlockDone",
    caseName: "corpus:cuda-120:day84_faultTolerantReductionKernel_block_done_grid_sync",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-84-Progress-Checkpoint.md",
    kernelName: "faultTolerantReductionKernel",
    workgroupSize: [4, 1, 1],
    ...
    output: "blockDone",
    expectedOutput: { type: "Int32Array", data: [1, 1] },
  },
  {
    sourceKey: "corpusCuda120Day84ReductionKernelGridSync",
    caseName: "corpus:cuda-120:day84_reductionKernel_grid_sync",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-84-Progress-Checkpoint.md",
    kernelName: "reductionKernel",
    workgroupSize: [4, 1, 1],
    options: { dynamicSharedMemory: { sdata: 16 } },
    launch: { gridDim: [2, 1, 1], blockDim: [4, 1, 1] },
    input: {
    ...
    output: "output",
    expectedOutput: { type: "Float32Array", data: [10, 26] },
  },
  {
    sourceKey: "corpusCuda120Day84CooperativeReductionKernel",
    caseName: "corpus:cuda-120:day84_cooperativeReductionKernel_grid_sync",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-84-Progress-Checkpoint.md",
    kernelName: "cooperativeReductionKernel",
    workgroupSize: [4, 1, 1],
  ...
  {
    sourceKey: "corpusCuda120Day84ParentKernelDevicePoolDynamicLaunch",
    caseName: "corpus:cuda-120:day84_parentKernel_device_pool_dynamic_launch",
    corpusId: "cuda-120",
    relativePath: "daily-updates/day-84-Progress-Checkpoint.md",
    kernelName: "parentKernel",
    workgroupSize: [1, 1, 1],
    ...
    input: {
      ...
      memoryPools: {
        dp: { data: { type: "Uint32Array", length: 256 }, offset: { type: "Uint32Array", data: [0] } },
      },
      scalars: { N: 4 },
      readback: ["output", "dp_offset"],
    },
    output: "output",
    offsetOutput: "dp_offset",
    expectedOffset: 1024,
    expectedOutput: { type: "Float32Array", data: [1, 1, 1, 1] },
  },
  {
  ...
  {
    sourceKey: "corpusCudaSamplesVoteAnyKernel1",
    caseName: "corpus:cuda-samples:VoteAnyKernel1",
    corpusId: "cuda-samples",
    relativePath: "cpp/0_Introduction/simpleVoteIntrinsics/simpleVote_kernel.cuh",
    kernelName: "VoteAnyKernel1",
    workgroupSize: [4, 1, 1],
    options: { features: { subgroups: true } },
    launch: { gridDim: [1, 1, 1], blockDim: [4, 1, 1] },
    input: {
      buffers: {
        input: { type: "Uint32Array", data: [0, 7, 0, 0] },
        result: { type: "Uint32Array", length: 4 },
      },
      scalars: { size: 4 },
    },
    output: "result",
    expectedOutput: { type: "Uint32Array", data: [1, 1, 1, 1] },
  },
  {
    sourceKey: "corpusCudaSamplesVoteAllKernel2",
    caseName: "corpus:cuda-samples:VoteAllKernel2",
    corpusId: "cuda-samples",
    relativePath: "cpp/0_Introduction/simpleVoteIntrinsics/simpleVote_kernel.cuh",
    kernelName: "VoteAllKernel2",
    workgroupSize: [4, 1, 1],
    options: { features: { subgroups: true } },
    launch: { gridDim: [1, 1, 1], blockDim: [4, 1, 1] },
    input: {
      buffers: {
        input: { type: "Uint32Array", data: [1, 1, 1, 0] },
        result: { type: "Uint32Array", length: 4 },
      },
      scalars: { size: 4 },
    },
  ...
  {
    sourceKey: "corpusCudaSamplesSimpleTemplatesTestKernel",
    caseName: "corpus:cuda-samples:simpleTemplates_testKernel_float",
    corpusId: "cuda-samples",
    relativePath: "cpp/0_Introduction/simpleTemplates/simpleTemplates.cu",
    kernelName: "testKernel",
    ...
    input: {
      buffers: {
        g_idata: { type: "Float32Array", data: [0, 1, 2, 3] },
        g_odata: { type: "Float32Array", length: 4 },
      },
      scalars: {},
    },
    output: "g_odata",
    expectedOutput: { type: "Float32Array", data: [0, 4, 8, 12] },
  },
  {
    sourceKey: "corpusCudaSamplesSimpleTemplatesTestKernelInt",
    caseName: "corpus:cuda-samples:simpleTemplates_testKernel_int",
    corpusId: "cuda-samples",
    relativePath: "cpp/0_Introduction/simpleTemplates/simpleTemplates.cu",
    kernelName: "testKernel",
    ...
    input: {
      buffers: {
        g_idata: { type: "Int32Array", data: [0, 1, 2, 3] },
        g_odata: { type: "Int32Array", length: 4 },
      },
      scalars: {},
    },
    output: "g_odata",
    expectedOutput: { type: "Int32Array", data: [0, 4, 8, 12] },
  },
  {
